...
CORRECTION CRITIQUE: TF-IDF/BM25 calculés sur le corpus entier, jamais phrase par phrase.
"""
...
class Corpus:
    ...
    def filter(self, query: str, ignore_case: bool = True):
        """
        Filtre par mots-clés avec option ignorer la casse.
        Retourne un nouveau Corpus filtré.
        """
    ...
    def compute_corpus_weights(self, model):
        """
        CRITIQUE: Calcule TF-IDF ou BM25 sur l'ENSEMBLE du corpus.
        """
